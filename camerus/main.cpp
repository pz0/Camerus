...
int main(int argc, char *argv[])
{
    ...
    camerus::core::output::VideoCreator video3("/tmp/resources/test3.avi", frame.cols * 3, frame.rows * 2, 15);
    ...
    while(!frame.empty())
    {
        ...
        cv::Mat concat_stage1, concat_stage2;
        ...
        camerus::core::output::concatenation::vertical_concat(concat_stage1, concat_stage2, concat_stage2);
        video3.write(concat_stage2);
